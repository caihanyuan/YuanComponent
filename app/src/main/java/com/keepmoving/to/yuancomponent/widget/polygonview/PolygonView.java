 ...
 * under the License.
 */
package com.keepmoving.to.yuancomponent.widget.polygonview;
...
public class PolygonView extends View {
    ...
    private final float strokeWidth = getResources().getDimension(R.dimen.polygon_stroke_paint_width);
